...
public class TeamB extends TeamAbstract {
	...
	public TeamB(Results results, int row, int pointsScored, int tries, int pointsConceded) {
	...
	public int[] UpdateResults(int[] leagueTableArray, Result r, int matchPointsNew) {
		...
		leagueTableArray[4] = leagueTableArray[4] + R.ReturnResult()[Row][3];
		leagueTableArray[5] = leagueTableArray[5] + R.ReturnResult()[Row][1];
		leagueTableArray[6] = leagueTableArray[6] + R.ReturnResult()[Row][4];
